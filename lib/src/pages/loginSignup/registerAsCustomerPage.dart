...
class RegisterAsCustomerPage extends StatefulWidget {
  @override
  State<RegisterAsCustomerPage> createState() => _RegisterAsCustomerPageState();
}

class _RegisterAsCustomerPageState extends State<RegisterAsCustomerPage> {
